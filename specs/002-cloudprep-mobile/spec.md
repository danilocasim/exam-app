...
- Q: What is the business model and monetization strategy? → A: Freemium model with Google Play subscriptions (Monthly $2.99, Quarterly $6.99, Annual $19.99); free tier gives 15 questions; single exam per app; content quality is the competitive moat; replicable architecture for future certifications.
